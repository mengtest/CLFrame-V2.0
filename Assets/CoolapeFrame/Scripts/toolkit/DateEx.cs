...
//			long us = (ms + d1.Ticks / 10000 + 28800000) * 10000;
		...
		public static string ToTimeStr2 (long msec)
		{
			...
			retstr = (day == 0) ? "" : day + Localization.Get ("UIDay");
			...
			retstr += ((retstr.Length > 0 || hour > 0) ? (hour + Localization.Get ("UIHour")) : "");
			...
			retstr += ((retstr.Length > 0 || minute > 0) ? (minute + Localization.Get ("UIMinute")) : "");

			second = (int)remainder % 60000;
			second = second / 1000;
			retstr += (second + Localization.Get ("UISecond"));
			return retstr;
		}
		...
		public static string ToTimeStr3 (long msec)
		{
			...
			//			minute = (int)remainder / 60000;
			//		}
			//		retstr += ((retstr.Length > 0 || minute > 0) ? (minute < 10 ? "0" + minute + Utl.getLocString ("UIMinute") : minute + Utl.getLocString ("UIMinute")) : "00" + Utl.getLocString ("UIMinute"));
			//			
			//		second = (int)remainder % 60000;
			//		second = second / 1000;
			//		retstr += (second < 10 ? "0" + second + Utl.getLocString ("UISecond") : second + Utl.getLocString ("UISecond"));
			return retstr;
		}
